...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/everdata/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/everdata/lib;)
...
COMBO_PLT = $(HOME)/.everdata_combo_dialyzer_plt
